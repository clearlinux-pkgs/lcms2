...
%prep
%setup -q -n lcms2-2.14
cd %{_builddir}/lcms2-2.14
pushd ..
cp -a lcms2-2.14 build32
popd
pushd ..
cp -a lcms2-2.14 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669152739
...
/usr/lib64/glibc-hwcaps/x86-64-v3/liblcms2.so.2.0.14
